...
@Component({
  selector: 'app-charity-article',
  templateUrl: './charity-article.component.html',
  styleUrls: ['./charity-article.component.scss']
})
export class CharityArticleComponent implements OnInit {
