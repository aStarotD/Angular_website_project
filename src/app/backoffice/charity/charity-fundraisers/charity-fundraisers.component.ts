...
@Component({
  selector: 'app-charity-fundraisers',
  templateUrl: './charity-fundraisers.component.html',
  styleUrls: ['./charity-fundraisers.component.scss']
})

export class CharityFundraisersComponent implements OnInit {
